...
final FAKE_CATEGORIES = [
  Category(id: 1, content: 'Sushi', color: Colors.deepOrange),
  Category(id: 2, content: 'Pizza', color: Colors.teal),
  Category(id: 3, content: 'Hamburgers', color: Colors.pink),
  Category(id: 4, content: 'Sushi', color: Colors.red),
  Category(id: 5, content: 'Pizza', color: Colors.yellow),
  Category(id: 6, content: 'Hamburgers', color: Colors.brown),
  Category(id: 7, content: 'Sushi', color: Colors.blue),
  Category(id: 8, content: 'Pizza', color: Colors.green),
  Category(id: 9, content: 'Hamburgers', color: Colors.orange),
];
var FAKE_FOODS = [
  ...
  Food(
      ...
      ingredients: ['Fontina cheese', 'Tomato sauce', 'Onions'],
      categoryId: 1),
  Food(
      name: "Tempura",
      urlImage:
      ...
      duration: Duration(minutes: 15),
      complexity: Complexity.Simple,
      ingredients: ['Fontina cheese', 'Onions', 'Mushrooms'],
      categoryId: 1),
  Food(
  ...
  Food(
      ...
      complexity: Complexity.Medium,
      ingredients: ['Tomato sauce', 'Onions', 'Mushrooms'],
      categoryId: 1),
  Food(
      ...
      duration: Duration(minutes: 20),
      complexity: Complexity.Hard,
      ingredients: ['Fontina cheese', 'Tomato sauce'],
      categoryId: 3),
];
